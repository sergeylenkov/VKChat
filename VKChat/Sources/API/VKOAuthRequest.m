...
- (id)init {
    ...
    if (self) {
        self.appID = @"";
        self.redirectURI = @"https://api.vk.com/blank.html";
...
- (NSURL *)oathURL {
    ...
    NSString *oauthLink = [NSString stringWithFormat:@"https://oauth.vk.com/authorize?client_id=%@&redirect_uri=%@&v=5.1", appID, redirectURI];
    NSString *type = @"page";
